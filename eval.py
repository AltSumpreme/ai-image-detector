...
def main() -> None:
    ...
    real_shift = evaluator.evaluate("real_shift", cfg["data_root"], cfg["batch_size"], cfg["num_workers"])
    stress = evaluator.evaluate("stress", cfg["data_root"], cfg["batch_size"], cfg["num_workers"])
    adversarial = evaluator.evaluate("adversarial", cfg["data_root"], cfg["batch_size"], cfg["num_workers"])
    ...
    print("Real Shift:", real_shift)
    print("Stress:", stress)
    print("Adversarial-like:", adversarial)
